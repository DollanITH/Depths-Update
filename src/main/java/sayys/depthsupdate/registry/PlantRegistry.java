...
public class PlantRegistry {
    public static final Block moss_block = new BlockSimple("moss_block", Material.GRASS, 0.1F, 0.1F, SoundType.PLANT);
    public static final Block moss_carpet = new BlockMossCarpet();
    public static final Block rooted_dirt = new BlockSimple("rooted_dirt", Material.GROUND, 0.5F, 0.5F, SoundType.GROUND);
    ...
    public static final RegistrationFeature ROOTED_DIRT_FEATURE = new RegistrationFeature(() -> DepthsUpdateConfig.REGISTRY.enableRootedDirt)
            .add(rooted_dirt);
