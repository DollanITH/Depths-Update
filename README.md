[![Available on CurseForge](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3.3.1/assets/cozy/available/curseforge_vector.svg)](https://www.curseforge.com/minecraft/mc-mods/depths-update) [![Available on Modrinth](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/cozy/available/modrinth_vector.svg)](https://modrinth.com/mod/depths-update)

# **⛏️ Depths Update**

**Depths Update** is an experimental, work-in progress mod that aims to backport features of the modern **Caves & Cliffs** updates into Minecraft 1.12.2.

## **🔑 Key Features**

### **Expanded World Depth**

The world generation bounds have been expanded, lowering the bedrock level to **y = -64**!

### **The Deepslate Layer & Ores**

Below Y=0, the world seamlessly transitions from standard Stone into **Deepslate**.

*   Features Deepslate variations for all vanilla ores and Copper.
*   Includes the full family of Deepslate building blocks including Slabs and Stairs.
...
### **Amethyst Geodes and More…**

![Cave Biomes](https://media.forgecdn.net/attachments/1571/361/lushanddripstone-custom-png.png) ![Amethyst Geodes](https://media.forgecdn.net/attachments/1610/280/amethyst-geode-with-crack-png.png)
...
*   [**AssetMover**](https://www.curseforge.com/minecraft/mc-mods/assetmover) (Client-side only; Versions 1.0.0-a2 and up).

***

### Also check out [**Explosive Enhancement**](https://www.curseforge.com/minecraft/mc-mods/explosive-enhancement-legacy)!
